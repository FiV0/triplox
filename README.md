...
```bash
docker pull ghcr.io/fiv0/triplox:0.1.0-alpha.6
docker run -p 5490:5490 ghcr.io/fiv0/triplox:0.1.0-alpha.6
```
...
```bash
docker run -p 5490:5490 -e TRIPLOX_STORAGE=local -v triplox-data:/var/lib/triplox  ghcr.io/fiv0/triplox:0.1.0-alpha.6
```
...
```bash
docker run -p 5490:5490 -e TRIPLOX_STORAGE=dev ghcr.io/fiv0/triplox:0.1.0-alpha.6
```
